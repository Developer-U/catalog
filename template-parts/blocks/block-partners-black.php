    ...
    <div class="container">
        ...
        <div class="row align-items-end justify-content-between">
            ...
            <div class="col-md-auto col-sm-12 sm:mt-24">
                <a href="#modal-contact-form" class="glightbox button -md -white text-black mt-32" data-glightbox="width: 900; height: auto;">
                    Начать проект
                </a>
            </div>
        </div>
        ...
        <div class="row y-gap-32 layout-pt-xs">
            ...
            <div class="col-lg-3 col-sm-6">
                <div data-anim="slide-up delay-1" class="clientsItem ratio ratio-3:2 border-dark rounded-4 py-4 bg-dark-2">
