...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_enqueue_style( 'child-vendors-style', get_stylesheet_directory_uri() . '/css/vendors.css', array( ));

		wp_enqueue_style( 'theme-style', get_stylesheet_directory_uri() . '/css/child-theme.min.css', array('child-vendors-style' ) );
		...
		wp_enqueue_script( 'jquery', get_stylesheet_directory_uri() . '/js/jquery-3.6.4.min.js', array(), $js_version, true );
		wp_enqueue_script( 'form', get_stylesheet_directory_uri() . '/js/form.js', array('jquery'), $js_version, true );
		wp_enqueue_script( 'child-vendors', get_stylesheet_directory_uri() . '/js/vendors.js', array('jquery'), $js_version, true );
		
		wp_enqueue_script( 'child-main', get_stylesheet_directory_uri() . '/js/child-theme.min.js', array('jquery'), $js_version, true );
